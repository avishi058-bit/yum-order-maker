...
export const TOPPINGS_PRICING: PricedOption[] = [
  ...
  { id: "pickled-jalapeno-side", name: "חלפניו מוחמץ ביתי בצד", price: 3 },
];
...
export const MEAL_DRINKS_PRICING: PricedOption[] = [
  ...
  { id: "drink-fanta-wildberry", name: "פאנטה פירות יער", price: 0 },
...
export const DEAL_DRINKS_PRICING: PricedOption[] = [
  ...
  { id: "deal-fanta-wildberry", name: "פאנטה פירות יער", price: 0 },
  ...
  { id: "fam-fanta-wildberry", name: "פאנטה פירות יער", price: 0 },
