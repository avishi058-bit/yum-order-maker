...
import { Printer, Save, ArrowRight } from "lucide-react";
...
const EventsKitchen = () => {
  ...
  const printPrep = async (b: any) => {
    const m = merged(b);
    // Save before printing so the printout reflects DB state
      ...
      <div className="max-w-5xl mx-auto space-y-4">
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <a href="/kitchen" className="inline-flex items-center gap-1 text-sm text-primary hover:underline">
            <ArrowRight className="w-4 h-4" /> חזרה למטבח
          </a>
        </div>
