      ...
      <Dialog open={modal !== null} onOpenChange={(o) => !o && setModal(null)}>
        <DialogContent className="sm:max-w-md" dir="rtl">
          ...
          {modal === "allergens" && (
            <>
              <DialogHeader>
                <DialogTitle>מידע על אלרגנים</DialogTitle>
              </DialogHeader>
              <div className="max-h-[70vh] overflow-y-auto space-y-3 text-sm text-muted-foreground leading-relaxed pr-1">
                <p>
                  המזון המוגש אצלנו מוכן במטבח פעיל שבו נעשה שימוש במגוון רחב של חומרי גלם, לרבות אלרגנים שונים.
                </p>
                <p>
                  למרות שאנו עושים מאמצים להפחית חשיפה לאלרגנים, אין באפשרותנו להבטיח סביבת הכנה סטרילית לחלוטין או היעדר מוחלט של אלרגנים מכל סוג שהוא.
                </p>
                <p>
                  ייתכן כי כל מוצר המוגש בעסק עלול להכיל, או לבוא במגע (זיהום משני), עם אחד או יותר מהאלרגנים הבאים:
                </p>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1 text-foreground list-disc pr-5">
                  <li>גלוטן (חיטה, שעורה, שיפון, כוסמין)</li>
                  <li>ביצים</li>
                  <li>שומשום</li>
                  <li>סויה</li>
                  <li>חרדל</li>
                  <li>דגים</li>
                  <li>בוטנים</li>
                  <li>אגוזים מכל הסוגים (שקדים, מלך, פקאן, קשיו, פיסטוק, לוז וכו׳)</li>
                  <li>סלרי</li>
                  <li>שום</li>
                  <li>בצל</li>
                  <li>תבלינים ותערובות תיבול</li>
                  <li>שמנים (כולל שמן טיגון משותף)</li>
                  <li>חומרי טעם וריח</li>
                  <li>חומרים משמרים</li>
                  <li>צבעי מאכל</li>
                </ul>
                <p>
                  בנוסף, קיימת אפשרות לזיהום משני עקב שימוש בציוד משותף, משטחי עבודה, שמנים לטיגון, כלי בישול ואחסון משותף של חומרי גלם.
                </p>
                <p>
                  מובהר בזאת כי כל המידע הנמסר ללקוח, בין אם בעל פה ובין אם בכתב, הינו מידע כללי בלבד ואינו מהווה התחייבות להיעדר אלרגנים במוצרים.
                </p>
                <p className="text-foreground font-semibold">לקוחות הסובלים מאלרגיות או רגישויות למזון מתבקשים:</p>
                <ul className="list-disc pr-5 space-y-1">
                  <li>ליידע את צוות המקום מראש</li>
                  <li>לבדוק את רכיבי המנה לפני ההזמנה</li>
                  <li>לשקול היטב את התאמת המוצר לצרכיהם האישיים</li>
                </ul>
                <p>
                  האחריות הבלעדית לבחירת המוצרים והתאמתם לצרכים התזונתיים והבריאותיים של הלקוח חלה על הלקוח בלבד.
                </p>
                <p>
                  הלקוח מצהיר כי ידוע לו שהמזון מוכן בסביבה שאינה סטרילית לאלרגנים, וכי הוא נוטל על עצמו את מלוא הסיכון הכרוך בצריכת המוצרים.
                </p>
                <p>
                  העסק לא יישא באחריות לכל נזק, תגובה אלרגית או פגיעה מכל סוג, ישירה או עקיפה, לרבות נזקי גוף, הנובעת מצריכת מזון שהוכן או הוגש במקום, למעט במקרים בהם נקבע אחרת על פי דין שאינו ניתן להתניה.
                </p>
              </div>
            </>
          )}
