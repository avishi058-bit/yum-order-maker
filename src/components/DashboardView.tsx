      ...
      <Card className="border-emerald-500/30">
        ...
        <CardContent className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            שכר, רואת חשבון (350 ₪ לפני מע״מ) והוצאות קבועות מתחלקים לפי ימי העבודה בפול בחודש (בחודש הנוכחי — לפי ממוצע ימי העבודה). שכירות, עובדים וכו׳ — מתחלק לפי מספר הימים בתקופה. שתייה ומוצרים ללא עלות מוגדרת לא נספרים בעלות. חשמל הוצאה לא מדווחת — מנוכה בסוף, אחרי ביטוח לאומי.
          </p>
        </CardContent>
      </Card>
